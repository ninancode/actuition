...
var employee_router_1 = __importDefault(require("./employee/employee.router"));
var request_router_1 = __importDefault(require("./request/request.router"));
...
*/
// app.use('/', indexRouter);
app.use('/employees', employee_router_1.default);
